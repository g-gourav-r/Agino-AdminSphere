...
function LoginPage() {
    ...
    const handleSubmit = (e) => {
        ...
        if (isValid) {
            const loginApiCall = createApiCall("api/admin/login", POST);
            ...
            <div className="auth-page container-fluid vh-100 d-flex">
                <div className="row w-100 flex-grow-1">
                    <div className="col-12 d-none vh-100 d-md-block col-md-7 d-flex align-items-center justify-content-center">
                        <div className="d-flex flex-column align-items-center justify-content-center vh-100 brand-logo text-center">
                            <div>
                                <h1>Agino</h1>
                                <h1 className="fs-1">AdminSphere</h1>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-5 d-flex align-items-center justify-content-center">
                        <div className="wrapper border p-5 rounded w-100 me-lg-4 mx-md-2">
                            ...
                            <hr />
                                <p>If you're a user, you're on the wrong page. Please click the button below to go to the user portal: <a href="https://app.agino.tech">app.agino.tech</a></p>
                        </div>
                    </div>
                </div>
            </div>
